...
def get_category_sector(index: int = 0) -> Tuple[str, str]:
    ...
    category_sector_list = [
        ("Workforce Health & Education", "Health"),
        ("Document Management & Logistics", "Education"),
        ("Financial Services", "Local Community and Housing"),
        ...
        ("Fleet", "Health"),
        ("Document Management & Logistics", "Health"),
        ("Network Services", "Education"),
        ("Financial Services", "Health"),
        ("Energy", "Health"),
        ("Energy", "Local Community and Housing"),
        ("Fleet", "Local Community and Housing"),
        ("Energy", "Education"),
        ("Technology Products & Services", "Local Community and Housing"),
        ...
        ("Network Services", "Defence and Security"),
        ("Digital Future", "Health"),
        ("Technology Products & Services", "Health"),
        ("Technology Products & Services", "Defence and Security"),
        ("Digital Future", "Defence and Security"),
        ("Digital Future", "Local Community and Housing"),
        ("Fleet", "Defence and Security"),
        ("Document Management & Logistics", "Government Policy"),
        ("Construction", "Education"),
        ("Network Services", "Government Policy"),
        ("Construction", "Local Community and Housing"),
        ("Financial Services", "Defence and Security"),
        ("Technology Products & Services", "Education"),
        ("People Services", "Government Policy"),
        ("Energy", "Defence and Security"),
        ("Travel", "Health"),
        ("Construction", "Defence and Security"),
        ("Technology Products & Services", "Government Policy"),
        ("Workforce Health & Education", "Education"),
        ("Energy", "Government Policy"),
        ("Travel", "Government Policy"),
        ("Workplace", "Health"),
        ("Technology Solutions & Outcomes", "Health"),
        ("Professional Services", "Government Policy"),
        ("Financial Services", "Government Policy"),
        ("Digital Future", "Education"),
        ("Workplace", "Defence and Security"),
        ("Digital Future", "Infrastructure"),
        ("People Services", "Defence and Security"),
        ("Fleet", "Government Policy"),
        ("Workforce Health & Education", "Government Policy"),
        ("Professional Services", "Health"),
        ("Travel", "Local Community and Housing"),
        ("Construction", "Health"),
        ("PSR & Permanent Recruitment", "Defence and Security"),
        ("Fleet", "Education"),
        ("Network Services", "Infrastructure"),
        ("Document Management & Logistics", "Culture, Media and Sport"),
        ("Travel", "Defence and Security"),
        ("People Services", "Health"),
        ...
        ("People Services", "Local Community and Housing"),
        ("Energy", "Infrastructure"),
        ("Technology Products & Services", "Infrastructure"),
        ("Marcomms & Research", "Government Policy"),
        ("Workplace", "Local Community and Housing"),
        ("Energy", "Culture, Media and Sport"),
        ("Fleet", "Infrastructure"),
        ("Workforce Health & Education", "Defence and Security"),
        ("Network Services", "Unassigned"),
        ("Professional Services", "Defence and Security"),
        ...
        ("People Services", "Education"),
        ("Travel", "Culture, Media and Sport"),
        ("Workplace", "Infrastructure"),
        ("Construction", "Infrastructure"),
        ("Technology Solutions & Outcomes", "Education"),
        ("PSR & Permanent Recruitment", "Health"),
        ("Fleet", "Unassigned"),
        ("Marcomms & Research", "Defence and Security"),
        ("Technology Solutions & Outcomes", "Infrastructure"),
        ("Fleet", "Culture, Media and Sport"),
        ("Marcomms & Research", "Health"),
        ("Marcomms & Research", "Infrastructure"),
        ("Technology Products & Services", "Unassigned"),
        ...
        ("Workforce Health & Education", "Infrastructure"),
        ("Marcomms & Research", "Education"),
        ("Construction", "Unassigned"),
        ("Professional Services", "Culture, Media and Sport"),
        ...
        ("Construction", "Culture, Media and Sport"),
        ("Workplace", "Culture, Media and Sport"),
        ("Digital Future", "Unassigned"),
        ("PSR & Permanent Recruitment", "Local Community and Housing"),
        ("Travel", "Unassigned"),
        ("PSR & Permanent Recruitment", "Education"),
        ("PSR & Permanent Recruitment", "Culture, Media and Sport"),
        ("Workplace", "Unassigned"),
        ("Contact Centres", "Government Policy"),
        ("Technology Solutions & Outcomes", "Unassigned"),
        ("People Services", "Unassigned"),
        ("Contact Centres", "Defence and Security"),
        ("Professional Services", "Unassigned"),
        ("Marcomms & Research", "Unassigned"),
        ("Contact Centres", "Health"),
        ("Financial Planning & Estates", "Government Policy"),
...
def arma_aic_scores(
    timeseries: Union[pd.Series, np.ndarray, list], pq_combinations: list
) -> pd.DataFrame:
    ...
    for p, q in pq_combinations:
        d = 0
        model = SARIMAX(timeseries, order=(p, d, q), simple_differencing=False).fit(
            disp=False
        )
        aic = model.aic
    ...
    df = (
        pd.DataFrame(data=aic_scores, columns=["p", "q", "aic"])
...
def arima_aic_scores(
    timeseries: Union[pd.Series, np.ndarray, list], pq_combinations: list, d: int
) -> pd.DataFrame:
    """Returns Akike Information Criteria (AIC) in ascending order for all models trained using the given parameters.
...
def model_arma(df: pd.DataFrame, category: str, sector: str, run: bool = False):
    ...
    if run:
        ...
        if not is_stationary:
            ...
            mape_last = mean_absolute_percentage_error(
                category_sector_spend["EvidencedSpend"][-test_size:],
                category_sector_spend["forecast_last_value"][-test_size:],
            )
...
def model_arima(df: pd.DataFrame, category: str, sector: str, run: bool = False):
    ...
    if run:
        ...
        test["last_month"] = (
            ...
            .iloc[train_size - 1 : dataset_size - 1]
            .values
        )
        ...
        last_month_mean_absolute_percentage_error = mean_absolute_percentage_error(
            test["EvidencedSpend"], test["last_month"]
        )
        arima_mean_absolute_percentage_error = mean_absolute_percentage_error(
            test["EvidencedSpend"], test["forecast"]
        )
        logger.debug(
...
def model_sarima(df: pd.DataFrame, category: str, sector: str, run: bool = False):
    ...
    if run:
        ...
        aic_scores = sarima_aic_scores(
            train["EvidencedSpend"], pqPQ_combinations, d, D, s
        )
        ...
        arima_pred = model_fit.get_prediction(
        ...
        sarima_mean_absolute_percentage_error = mean_absolute_percentage_error(
